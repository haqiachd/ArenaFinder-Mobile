...
public class VenueThirdModel {
    ...
    public VenueThirdModel(String venueImage, String venueName, String venueSport, float venueRatting, String venueStatus, String venueDesc) {
